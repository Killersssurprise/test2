...
public class AssetLoader {
    ...
    public static Texture texture_cw1, texture_cw2, texture_cw3, texture_cw4, texture_cw5, texture_cw6, texture_cw7,
    texture_cw8, texture_cw9, texture_cw10;
    public static TextureRegion cw1, cw2, cw3, cw4, cw5, cw6, cw7, cw8, cw9, cw10;
    
    public static BitmapFont text;
    
    public static Texture texture_scoreboard;
    ...
    public static void load() {
      ...
      //--------------------peoples(weapons)
        ...
        seal = new TextureRegion(texture_seal, 0, texture_seal.getHeight()/3, texture_seal.getWidth(), texture_seal.getHeight()/3);
        seal.flip(false, true);
        
        //----------------COST WEAPON
        texture_cw1 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw1.png"));
        texture_cw1.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw1 = new TextureRegion(texture_cw1, 0, 0, texture_cw1.getWidth(), texture_cw1.getHeight());
        cw1.flip(false, true);
        
        texture_cw2 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw2.png"));
        texture_cw2.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw2 = new TextureRegion(texture_cw2, 0, 0, texture_cw2.getWidth(), texture_cw2.getHeight());
        cw2.flip(false, true);
        
        texture_cw3 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw3.png"));
        texture_cw3.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw3 = new TextureRegion(texture_cw3, 0, 0, texture_cw3.getWidth(), texture_cw3.getHeight());
        cw3.flip(false, true);
        
        texture_cw4 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw4.png"));
        texture_cw4.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw4 = new TextureRegion(texture_cw4, 0, 0, texture_cw4.getWidth(), texture_cw4.getHeight());
        cw4.flip(false, true);
        
        texture_cw5 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw5.png"));
        texture_cw5.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw5 = new TextureRegion(texture_cw5, 0, 0, texture_cw5.getWidth(), texture_cw5.getHeight());
        cw5.flip(false, true);
        
        texture_cw6 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw6.png"));
        texture_cw6.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw6 = new TextureRegion(texture_cw6, 0, 0, texture_cw6.getWidth(), texture_cw6.getHeight());
        cw6.flip(false, true);
        
        texture_cw7 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw7.png"));
        texture_cw7.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw7 = new TextureRegion(texture_cw7, 0, 0, texture_cw7.getWidth(), texture_cw7.getHeight());
        cw7.flip(false, true);
        
        texture_cw8 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw8.png"));
        texture_cw8.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw8 = new TextureRegion(texture_cw8, 0, 0, texture_cw8.getWidth(), texture_cw8.getHeight());
        cw8.flip(false, true);
        
        texture_cw9 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw9.png"));
        texture_cw9.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw9 = new TextureRegion(texture_cw9, 0, 0, texture_cw9.getWidth(), texture_cw9.getHeight());
        cw9.flip(false, true);
        
        texture_cw10 = new Texture(Gdx.files.internal("data/gfx/costweapon/cw10.png"));
        texture_cw10.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        cw10 = new TextureRegion(texture_cw10, 0, 0, texture_cw10.getWidth(), texture_cw10.getHeight());
        cw10.flip(false, true);
        
        texture_scoreboard = new Texture(Gdx.files.internal("data/gfx/scoreboard.png"));
        texture_scoreboard.setFilter(TextureFilter.Nearest, TextureFilter.Nearest);
        
        scoreboard = new TextureRegion(texture_scoreboard, 0, 0, texture_scoreboard.getWidth(), texture_scoreboard.getHeight());
